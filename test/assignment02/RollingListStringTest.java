...
public class RollingListStringTest {

    RollingListString list;

    @Before
    public void setUp() throws Exception
    {
        list = new RollingListString(2f,0);
    }

    @Test
    public void testPrependSmallString(){
...
//        RollingListString myList = new RollingListString(1.0002f,10);
...
//    }
    ...
    public void testRemoveFirstException() {
        RollingListString emptyList = new RollingListString(1.2f,1);
        emptyList.removeFirst();
    }

    @Test(expected=NoSuchElementException.class)
    public void testRemoveLastException(){
        RollingListString emptyList = new RollingListString(3f,1);
        emptyList.removeLast();
    }

    @Test(expected=IndexOutOfBoundsException.class)
    public void testGetElementException(){
        RollingListString emptyList = new RollingListString(2f,0);
...
//        RollingListString emptyList = new RollingListString(1f,2);
